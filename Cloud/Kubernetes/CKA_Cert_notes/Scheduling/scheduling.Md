...
using the conecpt of Configmap as a volumee. Create a configmap with name my-scheduler-confug using the content of file
/root/my-scheduler-config.yaml...
A: kubectl create configmap --name my-scheduler-config
